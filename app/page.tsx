      ...
      <main className="pt-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/5 border border-white/10 p-12 rounded-[2rem] hover:bg-white/10 transition-all duration-500 group shadow-sm">
                <h3 className="text-3xl font-display font-medium mb-4 flex items-center gap-3 text-warm-white">
                  <span>Venture</span> <span className="text-brand">Scale</span>
                </h3>
              ...
              <div className="bg-white/5 border border-white/10 p-12 rounded-[2rem] hover:bg-white/10 transition-all duration-500 group shadow-sm">
                <h3 className="text-3xl font-display font-medium mb-4 flex items-center gap-3 text-warm-white">
                  <span>Venture</span> <span className="text-brand">Build</span>
                </h3>
                <p className="text-warm-white/80 leading-relaxed text-lg font-light mb-8">
        ...
        <section className="py-24 px-6 overflow-hidden">
          ...
          <div className="relative flex overflow-x-hidden group">
                ...
                <div key={i} className="flex gap-8 px-4 items-center">
                  {[
                    ...
                    <Link 
                      ...
                      className="w-48 h-24 bg-white border border-grey/30 rounded-2xl flex items-center justify-center hover:border-brand/50 hover:bg-white/80 transition-all duration-500 shrink-0 relative overflow-hidden p-4"
                    >
                      <Image 
                        src={item.logo} 
            ...
            <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-warm-white to-transparent pointer-events-none" />
            <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-warm-white to-transparent pointer-events-none" />
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-center">
              {[
                ...
                <div key={idx} className="p-10 border border-grey/30 rounded-[2rem] bg-white hover:bg-white hover:border-brand/30 transition-all duration-500 flex flex-col items-center justify-center gap-6 group">
                  <domain.icon className="w-10 h-10 text-grey/80 transition-colors duration-500 group-hover:text-brand" />
                  <h3 className="text-lg font-medium tracking-wide transition-colors duration-500 group-hover:text-brand">{domain.name}</h3>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-32 px-6 bg-white border-y border-grey/30">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white border border-grey/30 p-10 rounded-[2rem] hover:border-brand/30 transition-colors duration-500">
