    ...
    <div className="pt-32 pb-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 md:mb-32">
          ...
          <p className="text-xl text-navy max-w-3xl leading-relaxed mb-8 font-light">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full border border-grey/30">
              <TrendingUp className="text-brand w-5 h-5" />
              <span className="font-medium">Accelerated Growth</span>
            </div>
            <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full border border-grey/30">
              <Target className="text-brand w-5 h-5" />
              <span className="font-medium">Milestone-based Execution</span>
            </div>
            <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full border border-grey/30">
              <Zap className="text-brand w-5 h-5" />
              <span className="font-medium">Embedded Operators</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <div key={idx} className="group border border-grey/30 p-12 rounded-[2rem] hover:bg-white hover:border-brand/30 transition-all duration-500 bg-white">
              <h3 className="text-3xl font-display font-medium mb-8">{engine.title}</h3>
              <ul className="space-y-4">
                {engine.items.map((item, i) => (
                  <li key={i} className="text-navy flex items-start gap-3 text-lg font-light">
